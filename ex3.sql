-- ex3_NDG.sql
-- Fall 2023 Exercise 3
-- Revision History:
-- , Section 2, 2023.11.11: Created
-- , Section 2, 2023.11.11: Updated
...
-- Question 1
Print '--- Question 1 ---';
Print 'List the Invoice Number and Vendor Name columns for invoices with a Vendor Name of �Compuserve�. Use implicit syntax for the inner join.';
Print '';
...
-- Question 2
Print '--- Question 2 ---';
Print 'List the 5 columns (Invoice Number, Vendor ID, Vendor Name, Invoice Due Date and Balance Due) for invoices with �Balance Due� greater than $500. Use explicit syntax for the inner join. Sort the result by �Balance Due� in ascending order.';
Print '';

SELECT Invoices.InvoiceNumber, Vendors.VendorID, Vendors.VendorName, Invoices.InvoiceDueDate, Invoices.InvoiceTotal
FROM Invoices
...
-- Question 7
Print '--- Question 7 ---';
Print 'Construct a nested subquery that returns a list of Invoice Number, Invoice Date and Invoice Total columns for vendors in the state of Texas (TX). The inner query must use the Vendors table. Sort the result by Invoice Date in descending order.';
Print '';
